...
class Zend_Validate_File_Upload extends Zend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::INI_SIZE       => "Файл '%value%' превышает определенный размер",
        self::FORM_SIZE      => "Файл '%value%' превышает определенный размер формы",
        self::PARTIAL        => "Файл '%value%' был получен только частично",
        self::NO_FILE        => "Файл '%value%' не был загружен",
